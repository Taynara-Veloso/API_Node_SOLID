...
### O que é SOLID? 
  O acrônimo SOLID representa os cinco princípios que facilitam o processo de desenvolvimento.
  ...
  ![imgSolid](./public/solidPrinciples.png)
  ```
  ...
  ```
  O que facilita a manutenção e a expansão do software. 
